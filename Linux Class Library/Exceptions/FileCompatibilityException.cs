namespace Skyline.DataMiner.Utils.Linux.Exceptions
{
	...
	public class NotConnectedException : Exception
	{
		...
		public NotConnectedException()
			: base("Connection is needed before you can run commands.")
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="NotConnectedException"/> class with the command that failed.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NotConnectedException"/> class with the command that failed and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		/// <param name="message">The message of the exception.</param>
